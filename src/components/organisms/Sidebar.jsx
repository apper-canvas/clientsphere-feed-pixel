    ...
    <aside className={cn("bg-white border-r border-slate-200 p-6", className)}>
      ...
      <div className="mt-12 p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl">
        ...
        <button
          ...
          className="w-full px-3 py-2 bg-gradient-to-r from-accent to-emerald-600 text-white text-12 font-medium rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-200 transform hover:scale-105"
        >
          Learn More
        </button>
      </div>
